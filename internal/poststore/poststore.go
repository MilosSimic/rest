...
func (ts *PostStore) CreatePost(ctx context.Context, title string, text string, tags []string) int {
	span, _ := opentracing.StartSpanFromContext(ctx, "CreatePost")
	defer span.Finish()
...
func (ts *PostStore) GetPost(ctx context.Context, id int) (Post, error) {
	span, _ := opentracing.StartSpanFromContext(ctx, "GetPost")
	defer span.Finish()
...
func (ts *PostStore) DeletePost(ctx context.Context, id int) error {
	span, _ := opentracing.StartSpanFromContext(ctx, "DeletePost")
	defer span.Finish()
...
func (ts *PostStore) GetAllPosts(ctx context.Context) []Post {
	span, _ := opentracing.StartSpanFromContext(ctx, "GetAllPosts")
	defer span.Finish()
